...
$pageTitle = "Courses — {$department->name}";
...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mt-1">
        Courses in <span class="text-brand"><?= htmlspecialchars($department->name) ?></span>
    </h1>
</div>

<?php if (empty($courses)): ?>
    <div class="text-center py-12 text-gray-400">
        <p>No courses assigned to this department yet.</p>
        <a href="/courses/create" class="mt-2 inline-block text-brand hover:underline">Assign a course →</a>
    </div>
<?php else: ?>
        ...
        <table class="min-w-full divide-y divide-gray-200 bg-white">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900"><?= htmlspecialchars($course->name) ?></td>
